...
$$
where $S(u-)$ is the event-free survival probability just prior to $u$. As depicted in @fig-diag-geskus, the cumulative incidence summarises two key aspects of the competing risks process: surviving event-free until just prior to $t$, and then experiencing the $k^{\text{th}}$ event in the next instant.
...
<!-- Here again mention the peril of not accounting from comprisks, 1 minus km -->
