...
In addition to the current value parametrisation, we also ran the models assuming a time-dependent slopes association structure as $\alpha_{k1}m_i(t) + \alpha_{k2}\{\diff m_i(t)/\diff t\}$.

#### Goodness of fit {.unnumbered}

```{r}
#| label: fig-statsup-1
#| fig-cap: "Standardised residuals plots for Joint Model I (separate joint models for each cell type)."
#| echo: false
#| out-width: "100%"
...
```{r}
#| label: fig-statsup-2
#| fig-cap: "Standardised residuals plots for Joint Model II (separate joint models for each cell type)."
#| echo: false
#| out-width: "100%"
