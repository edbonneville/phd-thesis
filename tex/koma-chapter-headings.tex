...
\ChRuleWidth{1pt}
\KOMAoptions{chapterprefix}% Es ist ein Präfix-Stil % FIGURE OUT HERE
...
\renewcommand*{\chapterlineswithprefixformat}[3]{% Ebene, Nummer, Text
  \IfArgIsEmpty{#2}{}{%
    ...
    \begin{picture}(0,0)
      ...
      \usekomafont{chapternumber}{%
      \put(1.25\ChapterRuleWidth,0){% go from .5 -> 1 to remove annoying vertical thing next to text
