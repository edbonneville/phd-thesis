...
| Multiple imputation of missing covariates when using the Fine–Gray model (**Chapter 5**) | *Statistics in Medicine*                                     | [10.1002/sim.70166](https://doi.org/10.1002/sim.70166)       | [https://github.com/survival-lumc/FineGrayCovarMI](https://github.com/survival-lumc/FineGrayCovarMI) |
...
- [tex/before-body.tex](tex/before-body.tex) is my set-up for the 'non-scientific' part of the thesis required by Leiden University, and uses some pandoc variables.
