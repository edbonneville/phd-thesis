...
\hypersetup{
  pdftitle={Statistical modelling of competing risks with incomplete data},
  pdfauthor={Edouard Francis Bonneville},
  hidelinks,
...
for that disease
(\citeproc{ref-vanhouwelingenDynamicPredictionClinical2012}{van
...
leukaemia (AML)
(\citeproc{ref-horowitzGraftversusleukemiaReactionsBone1990}{Horowitz
...
(\citeproc{ref-horowitzRoleRegistriesFacilitating2008}{Horowitz, 2008}).
...
is that of \emph{censoring} (\citeproc{ref-Aalen2008}{Aalen \emph{et
al.}, 2008}). For an example study interested in time to disease relapse
...
(\citeproc{ref-chiangStochasticStudyLife1961}{1961}):
...
Lau and Lesko (\citeproc{ref-lauMissingnessSettingCompeting2018}{2018})
...
(\citeproc{ref-beyersmannCompetingRisksMultistate2012}{Beyersmann
...
(\citeproc{ref-kalbfleisch2011statistical}{2011}).

\begin{figure}

\centering{

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{figures/haz_surv_panels.png}
...
(\citeproc{ref-kaplanNonparametricEstimationIncomplete1958}{Kaplan and
Meier, 1958}). For a set of \(N\) ordered event times
...
\(t_j\) (\citeproc{ref-putterTutorialBiostatisticsCompeting2007}{Putter
\emph{et al.}, 2007}).
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{figures/fig-diag-geskus-1.pdf}

}

\caption{\label{fig-diag-geskus}Summary of the competing risks process,
adapted from Figure 1 in Geskus
(\citeproc{ref-geskusCompetingRisksConcepts2024}{2024})}
...
non-parametrically
(\citeproc{ref-aalenEmpiricalTransitionMatrix1978}{Aalen and Johansen,
1978}). It has been extensively discussed in the literature that
...
(\citeproc{ref-putterTutorialBiostatisticsCompeting2007}{Putter \emph{et
al.}, 2007}).
...
Gray's test (\citeproc{ref-grayClassKSampleTests1988}{Gray, 1988}).
...
(\citeproc{ref-prenticeAnalysisFailureTimes1978}{Prentice \emph{et al.},
1978}). The most popular approach for modelling the cause-specific
hazards is using the semi-parametric Cox proportional hazards model
(\citeproc{ref-coxRegressionModelsLifeTables1972}{Cox, 1972}), given for
...
(\citeproc{ref-breslow1972}{Breslow, 1972}).
...
(\citeproc{ref-fineProportionalHazardsModel1999}{Fine and Gray, 1999}),
...
\citeproc{ref-andersenInterpretabilityImportanceFunctionals2012}{Andersen
and Keiding, 2012}). Specifically, the Fine--Gray model exclusively
...
(\citeproc{ref-cornfieldEstimationProbabilityDeveloping1957}{1957}):
...
(\citeproc{ref-martinussenEstimationSeparableDirect2023a}{Martinussen
and Stensrud, 2023};
\citeproc{ref-youngCausalFrameworkClassical2020a}{Young \emph{et al.},
2020})
...
(\citeproc{ref-heitjanIgnorabilityCoarseData1991}{Heitjan and Rubin,
1991}), in that they are not ``fully'' missing: we do at least know that
...
(\citeproc{ref-carpenter2023MI}{Carpenter \emph{et al.}, 2023};
\citeproc{ref-endersAppliedMissingData2022}{Enders, 2022};
\citeproc{ref-buurenFlexibleImputationMissing2018}{van Buuren, 2018}).
...
(\citeproc{ref-sterneMultipleImputationMissing2009}{Sterne \emph{et
al.}, 2009}).
...
described in Enders (\citeproc{ref-endersAppliedMissingData2022}{2022}),
...
Rubin and colleagues (\citeproc{ref-little1987statistical}{Little and
Rubin, 1987}; \citeproc{ref-rubinInferenceMissingData1976}{Rubin, 1976})
developed a now ubiquitous framework for classifying missing data
mechanisms. Using similar notation to Little and Rubin
(\citeproc{ref-littleStatisticalAnalysisMissing2019}{2019}), let
...
(\citeproc{ref-seamanWhatMeantMissing2013}{2013}), where broader
...
(MCAR, \citeproc{ref-mariniMaximumLikelihoodEstimationPanel1980}{Marini
\emph{et al.}, 1980}) when the probability of any particular unit being
...
also Little (\citeproc{ref-littleMissingDataAssumptions2021}{2021}) for
...
outcome variable(s)
(\citeproc{ref-carpenterMissingDataStatistical2021}{Carpenter and Smuk,
2021}). Related to the latter point, there has been a movement towards
...
(\citeproc{ref-leeAssumptionsAnalysisPlanning2023}{Lee \emph{et al.},
2023}).
...
unobserved values
(\citeproc{ref-littleStatisticalAnalysisMissing2019}{Little and Rubin,
2019}). For example, one may choose to replace all missing values in a
...
(\citeproc{ref-rubin:1987}{Rubin, 1987}). These can be analysed
...
by Little (\citeproc{ref-littleMissingDataAnalysis2024}{2024}),
...
(e.g.~multivariate normal, see \citeproc{ref-carpenter2023MI}{Carpenter
\emph{et al.}, 2023}) for the variables in the dataset, and impute the
...
\citeproc{ref-vanbuurenFlexibleMultivariateImputation1999}{van Buuren
\emph{et al.}, 1999}). This approach is also known as \emph{fully
...
(\citeproc{ref-buurenFlexibleImputationMissing2018}{2018}).
...
datasets) inference
(\citeproc{ref-liuStationaryDistributionIterative2014}{Liu \emph{et
al.}, 2014}; \citeproc{ref-zhuConvergencePropertiesSequential2015}{Zhu
and Raghunathan, 2015}).
...
(\citeproc{ref-mengMultipleImputationInferencesUncongenial1994}{Meng,
1994}). For example, for models with multi-level or longitudinal
...
directly (\citeproc{ref-duCompatibilityImputationSpecification2022}{Du
\emph{et al.}, 2022};
\citeproc{ref-erlerDealingMissingCovariates2016}{Erler \emph{et al.},
2016}). This is also the case for regression models in the survival
setting (\citeproc{ref-antunesDealingMissingInformation2021}{Antunes
\emph{et al.}, 2021};
\citeproc{ref-bartlettMultipleImputationCovariates2015}{Bartlett
\emph{et al.}, 2015};
\citeproc{ref-beesleyMultipleImputationMissing2016}{Beesley \emph{et
al.}, 2016};
\citeproc{ref-haenschMultipleImputationPartially2022}{Haensch \emph{et
al.}, 2022}; \citeproc{ref-whiteImputingMissingCovariate2009}{White and
Royston, 2009}).
...
(\citeproc{ref-molenberghsIncompleteDataIntroduction2008}{2008}) for
further details.
...
(\citeproc{ref-rizopoulosJointModelsLongitudinal2012}{Rizopoulos,
...
\citeproc{ref-molenberghsIncompleteDataIntroduction2008}{Molenberghs and
Fitzmaurice, 2008}), when conditioning on
...
(\citeproc{ref-papageorgiouAlternativeCharacterizationMAR2021}{Papageorgiou
...
(\citeproc{ref-littleModelingDropOutMechanism1995}{Little, 1995}).
...
as exogenous (\citeproc{ref-kalbfleisch2011statistical}{Kalbfleisch and
Prentice, 2011};
\citeproc{ref-rizopoulosJointModelsLongitudinal2012}{Rizopoulos, 2012};
\citeproc{ref-sweetingJointModellingLongitudinal2011}{Sweeting and
Thompson, 2011}).
...
(\citeproc{ref-hickeyJointModellingTimetoevent2016}{Hickey \emph{et
al.}, 2016}). Furthermore, Papageorgiou \emph{et al.}
(\citeproc{ref-papageorgiouOverviewJointModeling2019a}{2019}) outline
...
al.} (\citeproc{ref-hickeyComparisonJointModels2018a}{2018}) provide an
...
(\citeproc{ref-rizopoulosJointModelsLongitudinal2012}{2012}) (based on
...
(\citeproc{ref-hayatirezvanRiseMultipleImputation2015}{Hayati Rezvan
\emph{et al.}, 2015}), we did not know whether this is also the case for
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{Bartlett and
Taylor, 2016}) as part of large simulation study. A novel aspect of this
...
(\citeproc{ref-scheteligLateTreatmentrelatedMortality2019}{Schetelig
\emph{et al.}, 2019}). This chapter is based on:
...
(\citeproc{ref-lauMissingnessSettingCompeting2018}{2018}), there is a
...
(\citeproc{ref-salzmann-manriqueJointModelingImmune2018a}{2018})), and
...
(\citeproc{ref-sterneMultipleImputationMissing2009}{Sterne \emph{et
al.}, 2009}). Insufficient reporting of missing values may also
...
outcome models (\citeproc{ref-bellHandlingMissingData2014}{Bell \emph{et
al.}, 2014}; \citeproc{ref-burtonMissingCovariateData2004}{Burton and
Altman, 2004}; \citeproc{ref-carrollHowAreMissing2020}{Carroll \emph{et
al.}, 2020}; \citeproc{ref-sullivanTreatmentMissingData2017}{Sullivan
\emph{et al.}, 2017}).
...
(\citeproc{ref-delgadoSurvivalAnalysisHematologic2014}{2014}), which are
...
(\citeproc{ref-hughesAccountingMissingData2019}{Hughes \emph{et al.},
2019}). In turn, when missingness depends on the outcome, or observed
...
(\citeproc{ref-dondersReviewGentleIntroduction2006}{Donders \emph{et
al.}, 2006}). Nevertheless, it may prove to be a pragmatic solution
under particular assumptions and mild confounding
(\citeproc{ref-blakeEstimatingTreatmentEffects2020}{Blake \emph{et al.},
2020}).
...
(\citeproc{ref-sterneMultipleImputationMissing2009}{Sterne \emph{et
al.}, 2009}). Data are analyzed as if they were complete (i.e.~failing
...
(\citeproc{ref-armandValidationRefinementDisease2014}{Armand \emph{et
al.}, 2014}). In different implementations of the DRI, patients with
...
(\citeproc{ref-armandDiseaseRiskIndex2012}{Armand \emph{et al.}, 2012};
\citeproc{ref-saccardiBenchmarkingSurvivalOutcomes2023}{Saccardi
\emph{et al.}, 2023};
\citeproc{ref-snowdenBenchmarkingSurvivalOutcomes2020}{Snowden \emph{et
al.}, 2020}). In the original implementation of the DRI, this was
...
(\citeproc{ref-whiteBiasEfficiencyMultiple2010}{White and Carlin,
2010}).

There are different variants of MI, of which the best known is
multivariate imputation by chained equations (MICE)
(\citeproc{ref-vanbuurenFlexibleMultivariateImputation1999}{van Buuren
\emph{et al.}, 1999}), implemented for example in the `mice' R package
(\citeproc{ref-vanbuurenMiceMultivariateImputation2011}{van Buuren and
...
(\citeproc{ref-mertensConstructionAssessmentPrediction2020}{Mertens
\emph{et al.}, 2020}; \citeproc{ref-vonhippelHowManyImputations2020}{von
Hippel, 2020}). Generally, at least 10-20 iterations are recommended,
...
(SMC-FCS)(\citeproc{ref-bartlettMultipleImputationCovariates2015}{Bartlett
\emph{et al.}, 2015}), implemented in the `smcfcs' R package
(\citeproc{ref-bartlettSmcfcsMultipleImputation2022}{Bartlett \emph{et
al.}, 2022}).

A closely related approach to SMC-FCS is fully Bayesian imputation,
implemented in the `JointAI' R package
(\citeproc{ref-erlerJointAIJointAnalysis2021}{Erler \emph{et al.},
2021}). This performs analysis and imputation simultaneously, again
...
and Smuk (\citeproc{ref-carpenterMissingDataStatistical2021}{Carpenter
and Smuk, 2021}).
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{White and Royston,
2009}) suggested that the imputation model for a partially observed
...
(\citeproc{ref-keoghMultipleImputationCox2018}{Keogh and Morris, 2018}),
excess hazard models
(\citeproc{ref-antunesDealingMissingInformation2021}{Antunes \emph{et
al.}, 2021}), and competing risks
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{Bartlett and
Taylor, 2016};
\citeproc{ref-bonnevilleMultipleImputationCausespecific2022}{Bonneville
...
\emph{et al.} (\citeproc{ref-carrollHowAreMissing2020}{2020}), namely
...
\emph{et al.} (\citeproc{ref-hansenELN2017Genetic2021}{2021}) It is
...
(\citeproc{ref-hanSecondaryCytogeneticAbnormalities2021}{2021}) provide
...
(\citeproc{ref-sharmaOutcomesPediatricPatients2021}{2021}), where
...
(\citeproc{ref-inoueImpactConditioningIntensity2021}{2021}) provide an
...
(\citeproc{ref-scheteligLateTreatmentrelatedMortality2019}{2019}),
...
(\citeproc{ref-bonnevilleMultipleImputationCausespecific2022}{2022}).
...
(\citeproc{ref-carpenterMissingDataStatistical2021}{Carpenter and Smuk,
2021}). Of course in reality, missingness will often be a mixture of MAR
...
equal (\citeproc{ref-whiteMissingDataPart2022}{White \emph{et al.},
2022}). One could indeed make the case that in the present example,
...
(\citeproc{ref-blakeEstimatingTreatmentEffects2020}{2020}) concern
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/haema-review_forest-EFS.pdf}
...
(\citeproc{ref-sterneMultipleImputationMissing2009}{Sterne \emph{et
al.}, 2009}; \citeproc{ref-sterneROBINSIToolAssessing2016}{Sterne
\emph{et al.}, 2016};
\citeproc{ref-vandenbrouckeStrengtheningReportingObservational2007}{Vandenbroucke
\emph{et al.}, 2007}) can be found in Table 1 from
(\citeproc{ref-carrollHowAreMissing2020}{Carroll \emph{et al.}, 2020}),
and should be considered alongside further guidelines given by
(\citeproc{ref-leeFrameworkTreatmentReporting2021}{Lee \emph{et al.},
2021}). The aforementioned guidelines put findings concerning missing
...
(\citeproc{ref-pazGenomicAnalysisPrimary2021}{2021}) were perhaps the
...
of 5 years (\citeproc{ref-hayatirezvanRiseMultipleImputation2015}{Hayati
...
(\citeproc{ref-carrollHowAreMissing2020}{2020}). We effectively accepted
...
(\citeproc{ref-groenwoldMissingCovariateData2012}{Groenwold \emph{et
al.}, 2012}), its use has been approved for randomized trials
(\citeproc{ref-sullivanShouldMultipleImputation2018}{Sullivan \emph{et
al.}, 2018}; \citeproc{ref-whiteAdjustingPartiallyMissing2005}{White and
Thompson, 2005}). For observational studies, the flowchart shown in
Figure 3 in Lee \emph{et al.}
(\citeproc{ref-leeFrameworkTreatmentReporting2021}{2021}) provides a
...
(\citeproc{ref-madley-dowdProportionMissingData2019}{Madley-Dowd
...
\markleft{\thechapter~Multiple imputation for cause-specific Cox models}
...
in medicine (\citeproc{ref-carrollHowAreMissing2020}{Carroll \emph{et
al.}, 2020}). The backbone of such studies are clinical registries,
...
(\citeproc{ref-murrayMultipleImputationReview2018}{Murray, 2018}). A
...
(\citeproc{ref-rubin:1987}{Rubin, 1987}). The imputation model and the
...
(\citeproc{ref-vanbuurenFullyConditionalSpecification2006}{van Buuren
\emph{et al.}, 2006}). This involves specifying an imputation model for
...
(MICE) (\citeproc{ref-vanbuurenFlexibleMultivariateImputation1999}{van
Buuren \emph{et al.}, 1999}).

In time-to-event analysis, a popular choice of substantive model is the
Cox proportional hazards model. White and Royston
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}) showed that
...
(\citeproc{ref-bartlettMultipleImputationCovariates2015}{2015}) proposed
...
(\citeproc{ref-lauMissingnessSettingCompeting2018}{Lau and Lesko,
2018}). The most prominent work is that of Bartlett and Taylor
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}), where the
...
\emph{et al.}
(\citeproc{ref-resche-rigonImputingMissingCovariate2012}{2012}). The
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{Bartlett and
Taylor, 2016}). In contrast, the approximate MICE approach was often
...
presentation
(\citeproc{ref-resche-rigonImputingMissingCovariate2012}{Resche-Rigon
...
(\citeproc{ref-adesMyelodysplasticSyndromes2014}{Adès \emph{et al.},
2014}). AlloHCT is the only treatment that can offer long-term remission
...
\emph{et al.}, 2012};
\citeproc{ref-putterTutorialBiostatisticsCompeting2007}{Putter \emph{et
al.}, 2007}). A model can then be specified, conditional on a covariate
...
(\citeproc{ref-coxPartialLikelihood1975}{Cox, 1975}). This follows from
...
just prior to \(u\)
(\citeproc{ref-andersenCompetingRisksMultistate2002}{Andersen \emph{et
al.}, 2002}). This cumulative incidence function, or transition
...
McCullagh and Nelder (\citeproc{ref-mccullagh1989generalized}{1989}) for
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}), this
...
(\citeproc{ref-bartlettMultipleImputationCovariates2015}{2015}) for a
detailed introduction of the SMC-FCS method, and to the work of Bartlett
and Taylor (\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016})
...
imputation variance (\citeproc{ref-rubin:1987}{Rubin, 1987}). The
...
(\citeproc{ref-woodEstimationUsePredictions2015}{2015}) and Mertens
\emph{et al.}
(\citeproc{ref-mertensConstructionAssessmentPrediction2020}{2020})
...
(\citeproc{ref-demirtasComputingPointbiserialCorrelation2016}{2016}) for
...
(\citeproc{ref-beyersmannSimulatingCompetingRisks2009}{Beyersmann
\emph{et al.}, 2009}).
...
(\citeproc{ref-kleinSurvivalAnalysisTechniques2006}{2003}).
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}) results to the
...
(\citeproc{ref-morrisUsingSimulationStudies2019}{2019}) this is defined
as
...
(\citeproc{ref-rcoreteamLanguageEnvironmentStatistical2020}{R Core Team,
2020}). The substantive model compatible imputation was performed using
the smcfcs package version 1.4.1
(\citeproc{ref-bartlettSmcfcsMultipleImputation2022}{Bartlett \emph{et
al.}, 2022}) and MICE was performed using the mice package version 3.8.0
(\citeproc{ref-vanbuurenMiceMultivariateImputation2011}{van Buuren and
...
(\citeproc{ref-dewreedeMstatePackageAnalysis2011}{de Wreede \emph{et
al.}, 2011}).
...
(\citeproc{ref-ruckerPresentingSimulationResults2014}{Rücker and
Schwarzer, 2014}). For example, the left-most bin in the plot
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cause-specific-MI_MAR-B1-NLP.pdf}
...
Bartlett and Taylor
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}). Second,
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cause-specific-MI_MAR-T-B1-NLP.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cause-specific-MI_MAR-pred-NLP.pdf}
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{White and Royston,
2009}). The second study assessed the performance of the MI methods in
...
(\citeproc{ref-madley-dowdProportionMissingData2019}{Madley-Dowd
\emph{et al.}, 2019}; \citeproc{ref-vonhippelHowManyImputations2020}{von
Hippel, 2020}). We first ran a set of \(m = 20\) imputations, with
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}). Third, we
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cause-specific-MI_forest-rel.pdf}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cause-specific-MI_forest-nrm.pdf}
...
(\citeproc{ref-dewreedeMstatePackageEstimation2010}{de Wreede \emph{et
al.}, 2010}). Subsequently, the 95\% CIs were constructed after
transformation on the complementary log-log scale, as described in the
work of Morisot \emph{et al.}
(\citeproc{ref-morisotProstateCancerNet2015}{2015}). For comparability,
...
\caption{\label{tbl-cuminc-mds}Predicted cumulative incidence (\%) of
both REL and NRM at 5-years for three reference patients with different
MDS classes, reference levels for categorical covariates and sample
median values for continuous covariates. The 95\% confidence intervals
were constructed based on a complementary log-log transformation.}
...
registry (\citeproc{ref-snowdenBenchmarkingSurvivalOutcomes2020}{Snowden
\emph{et al.}, 2020}).
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}) on Cox
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}). Namely,
...
(\citeproc{ref-leeMultipleImputationPresence2017}{Lee and Carlin,
2017a}). This may in turn prevent unnecessary categorisation of these
...
(\citeproc{ref-falcaroEstimatingExcessHazard2015}{Falcaro \emph{et al.},
2015}; \citeproc{ref-quartagnoMultipleImputationDiscrete2019}{Quartagno
and Carpenter, 2019}).
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}), with
...
Bartlett and Taylor
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}) shows that
...
(\citeproc{ref-keoghMultipleImputationCox2018}{Keogh and Morris, 2018};
\citeproc{ref-marshallComparisonImputationMethods2010}{Marshall \emph{et
al.}, 2010}; \citeproc{ref-shahComparisonRandomForest2014}{Shah \emph{et
...
(\citeproc{ref-bakoyannisModellingCompetingRisks2010}{Bakoyannis
\emph{et al.}, 2010};
\citeproc{ref-delordMultipleImputationCompeting2016}{Delord and Génin,
2016}) We conclude by remarking that likelihood-based and fully Bayesian
...
applications (\citeproc{ref-erlerDealingMissingCovariates2016}{Erler
\emph{et al.}, 2016}).
...
\addcontentsline{toc}{subsubsection}{Binary X}
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}), we use a first
...
\addcontentsline{toc}{subsubsection}{Nominal categorical X}
...
\addcontentsline{toc}{subsubsection}{Ordered categorical X}
...
\addcontentsline{toc}{subsubsection}{Continuous X}
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}), this is only
...
(\citeproc{ref-acosta-medinaComparisonPretransplantationPrediction2023}{Acosta-Medina
\emph{et al.}, 2023}). The Myelofibrosis Transplant Scoring System
...
(\citeproc{ref-krogerIndicationManagementAllogeneic2024}{Kröger \emph{et
al.}, 2024}).
...
(\citeproc{ref-polverelliImpactSpleenSize2021a}{Polverelli \emph{et
al.}, 2021}). Inclusion and exclusion criteria, definitions, and
...
(\citeproc{ref-polverelliMultidimensionalGeriatricAssessment2020}{Polverelli
\emph{et al.}, 2020}). Other comorbidities present in more than 5\% of
...
(\citeproc{ref-sorrorHematopoieticCellTransplantation2005a}{Sorror
\emph{et al.}, 2005}), the prevalence of comorbidities was higher in our
...
after allo-HCT
(\citeproc{ref-sorrorHematopoieticCellTransplantation2005a}{Sorror
\emph{et al.}, 2005}). In this context, it seems evident that overweight
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/polverelli_bmi-hrs.jpg}
...
(\citeproc{ref-polverelliMultidimensionalGeriatricAssessment2020}{Polverelli
\emph{et al.}, 2020}). Third, the amount of missing data for both main
...
(\citeproc{ref-polverelliImpactSpleenSize2021a}{Polverelli \emph{et
al.}, 2021},
\citeproc{ref-polverelliSplenomegalyPatientsPrimary2023}{2023}) to
...
(\citeproc{ref-sorrorHematopoieticCellTransplantation2005a}{2005}). BMI
...
system (\citeproc{ref-passamontiDynamicPrognosticModel2010}{Passamonti
\emph{et al.}, 2010}) risk score other than patient age. These DIPSS
...
mortality) (\citeproc{ref-lennonObesityParadoxCancer2016}{Lennon
\emph{et al.}, 2016}).
...
equations (MICE)
(\citeproc{ref-vanbuurenFlexibleMultivariateImputation1999}{van Buuren
\emph{et al.}, 1999}), with 100 imputed datasets and 20 iterations. This
...
biased (\citeproc{ref-bonnevilleHandlingMissingCovariate2023}{Bonneville
\emph{et al.}, 2023}). The imputation model for each partially observed
...
(\citeproc{ref-bonnevilleMultipleImputationCausespecific2022}{Bonneville
\emph{et al.}, 2022}). Each comorbidity variable was imputed separately
...
(\citeproc{ref-carpenterMissingDataStatistical2021}{Carpenter and Smuk,
2021}). Compared to a complete-case analysis (CCA), MI can provide
...
(\citeproc{ref-vanbuurenFlexibleMultivariateImputation1999}{1999})).

In the context of cause-specific Cox proportional hazards models
(\citeproc{ref-prenticeAnalysisFailureTimes1978}{Prentice \emph{et al.},
1978}), it has been shown that the imputation model for a partially
...
model(\citeproc{ref-whiteImputingMissingCovariate2009}{White and
Royston, 2009}). Concretely, when the outcome model assumes proportional
...
\citeproc{ref-bartlettMultipleImputationCovariates2015}{Bartlett
\emph{et al.}, 2015}) approach, and it was extended by Bartlett and
Taylor to accommodate cause-specific Cox substantive models
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{Bartlett and
Taylor, 2016}). In terms of estimating cause-specific hazard ratios,
...
covariate (\citeproc{ref-lauMissingnessSettingCompeting2018}{Lau and
...
al.} (\citeproc{ref-archerDevelopmentExternalValidation2022}{2022})
...
\emph{et al.} (\citeproc{ref-cliftLivingRiskPrediction2020}{2020}) used
...
(\citeproc{ref-ruanAnalysesCumulativeIncidence2008}{Ruan and Gray,
2008}), and thereafter use existing SMC-FCS methodology (originally
developed for the standard Cox model,
\citeproc{ref-bartlettMultipleImputationCovariates2015}{Bartlett
\emph{et al.}, 2015}) to impute the missing covariates in a second step.
...
Taylor (\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}),
...
(\citeproc{ref-bonnevilleMultipleImputationCausespecific2022}{2022}). As
...
(\citeproc{ref-putterRelationCausespecificHazard2020}{Putter \emph{et
al.}, 2020}). The CS-SMC and CS-Approx approaches can therefore be
...
(\citeproc{ref-grayClassKSampleTests1988}{Gray, 1988}). These
...
(\citeproc{ref-austinFineGraySubdistributionHazard2021}{Austin \emph{et
al.}, 2021}). An additional example concerns the approach described in
...
(\citeproc{ref-bonnevilleWhyYouShould2024}{2024 (in press)}).
...
(\citeproc{ref-fineProportionalHazardsModel1999}{1999}) referred to
...
\citeproc{ref-bartlettMultipleImputationCovariates2015}{Bartlett
\emph{et al.}, 2015}), but instead using \(V\) and \(I(D = 1)\) as our
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{2009}) in the
...
(\citeproc{ref-ruanAnalysesCumulativeIncidence2008}{2008}) suggested the
use of Kaplan--Meier (KM) imputation
(\citeproc{ref-taylor2002survival}{Taylor \emph{et al.}, 2002}).
...
(\citeproc{ref-rubin:1987}{Rubin, 1987}).
...
moments (\citeproc{ref-molenberghsHandbookMissingData2014}{Molenberghs
\emph{et al.}, 2014}).
...
of censoring times
(\citeproc{ref-allignolSoftwareFittingNonstandard2010}{Allignol and
Beyersmann, 2010}), and \{smcfcs\} for the imputation of the missing
covariates (\citeproc{ref-bartlettSmcfcsMultipleImputation2022}{Bartlett
\emph{et al.}, 2022}) - see Figure~\ref{fig-workflow} for an
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_workflow2.png}
...
(\citeproc{ref-ruanAnalysesCumulativeIncidence2008}{2008}) discussed
...
(\citeproc{ref-lambertFlexibleParametricModelling2017}{2017}), this
...
simulation study (\citeproc{ref-morrisUsingSimulationStudies2019}{Morris
\emph{et al.}, 2019}).
...
(\citeproc{ref-beyersmannCompetingRisksMultistate2012}{2012}), and
originally used in the simulations by Fine and Gray
(\citeproc{ref-fineProportionalHazardsModel1999}{1999}). This approach
...
(\citeproc{ref-kleinSurvivalAnalysisTechniques2006}{2003})) multiplied
...
(\citeproc{ref-grambauerProportionalSubdistributionHazards2010}{Grambauer
\emph{et al.}, 2010}).
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_scenarios-vis.pdf}
...
(\citeproc{ref-buurenFlexibleImputationMissing2018}{2018}). For the
...
Morisot \emph{et al.}
(\citeproc{ref-morisotProstateCancerNet2015}{2015}) and recommended by
Marshall \emph{et al.}
(\citeproc{ref-marshallCombiningEstimatesInterest2009}{2009}). This
predict-then-pool approach (rather than predicting using a pooled model)
has been recommended by multiple authors
(\citeproc{ref-mertensConstructionAssessmentPrediction2020}{Mertens
\emph{et al.}, 2020};
\citeproc{ref-woodEstimationUsePredictions2015}{Wood \emph{et al.},
2015}).
...
(\citeproc{ref-rcoreteamLanguageEnvironmentStatistical2023}{R Core Team,
2023}). Core packages used were: \{survival\} version 3.5.7
(\citeproc{ref-survival-package}{Therneau, 2023}), \{mice\} version
3.16.0 (\citeproc{ref-vanbuurenMiceMultivariateImputation2011}{van
Buuren and Groothuis-Oudshoorn, 2011}), \{smcfcs\} version 1.7.1
(\citeproc{ref-bartlettSmcfcsMultipleImputation2022}{Bartlett \emph{et
al.}, 2022}), \{kmi\} version 0.5.5
(\citeproc{ref-allignolSoftwareFittingNonstandard2010}{Allignol and
Beyersmann, 2010}), and \{rsimsum\} version 0.11.3
(\citeproc{ref-gaspariniRsimsumSummariseResults2018}{Gasparini, 2018}).
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_bias-X.pdf}
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{White and Royston,
2009}). When the DGM generated event times under proportional
...
(\citeproc{ref-fineProportionalHazardsModel1999}{1999}) and Ruan and
Gray (\citeproc{ref-ruanAnalysesCumulativeIncidence2008}{2008}), that
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_perf-X.pdf}
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_preds-baseline.pdf}
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_preds-X1Z1.pdf}
...
(\citeproc{ref-polverelliImpactComorbiditiesBody2024a}{Polverelli
...
treatment
(\citeproc{ref-krogerIndicationManagementAllogeneic2024}{Kröger \emph{et
al.}, 2024}). In the original study, the primary objective was to
...
(\citeproc{ref-vonhippelHowManyImputations2020}{von Hippel, 2020}).
...
(\citeproc{ref-RJ-2017-062}{2017}). The estimates using both FG-SMC and
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_applied-base-cuminc.pdf}
...
imputation of potential censoring times
(\citeproc{ref-gorgizadehImputationApproachUsing2022a}{Gorgi Zadeh
\emph{et al.}, 2022}).
...
(\citeproc{ref-putterRelationCausespecificHazard2020}{2020})) is closer
...
(\citeproc{ref-grambauerProportionalSubdistributionHazards2010}{Grambauer
\emph{et al.}, 2010};
\citeproc{ref-vanderpasDifferentCompetingRisks2018}{van der Pas \emph{et
al.}, 2018}).
...
standard Cox models (\citeproc{ref-keoghMultipleImputationCox2018}{Keogh
and Morris, 2018}). Third, the proposed approach can be extended to
accommodate interval censored outcomes, using the methodology described
by Delord and Génin
(\citeproc{ref-delordMultipleImputationCompeting2016}{2016}), which
...
(\citeproc{ref-bonnevilleWhyYouShould2024a}{Bonneville \emph{et al.},
2024}). When multiple competing events are of interest, we would instead
recommend modelling the cause-specific hazards, or using the
semiparametric approach suggested by Mao and Lin
(\citeproc{ref-maoEfficientEstimationSemiparametric2017}{2017}) for
...
\citeproc{ref-latoucheCompetingRisksAnalysis2013}{Latouche \emph{et
al.}, 2013}), and can at the same time be used for prognostic modelling
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-MI_cens-appendix.pdf}
...
(\citeproc{ref-putterTutorialBiostatisticsCompeting2007}{Putter \emph{et
al.}, 2007}). The former is often the tool of choice when developing
...
together (\citeproc{ref-andersenCompetingRisksEpidemiology2012}{Andersen
\emph{et al.}, 2012};
\citeproc{ref-gerdsAbsoluteRiskRegression2012a}{Gerds \emph{et al.},
2012}; \citeproc{ref-latoucheCompetingRisksAnalysis2013}{Latouche
\emph{et al.}, 2013}). For example, as emphasized by Latouche \emph{et
al.} (\citeproc{ref-latoucheMisspecifiedRegressionModel2007}{2007}), the
...
(\citeproc{ref-shimoniLongtermSurvivalLate2016}{2016}) for an example of
...
(\citeproc{ref-austinFineGraySubdistributionHazard2021}{2021}) with data
...
function (\citeproc{ref-grayClassKSampleTests1988}{Gray, 1988}).
...
\section{Data-generating mechanisms}\label{data-generating-mechanisms-2}
...
(\citeproc{ref-andersenModelsMultiStateSurvival2023}{2023}). Since the
...
and Ulm (\citeproc{ref-hallerFlexibleSimulationCompeting2014}{2014})\}.
Namely,
...
(\citeproc{ref-putterRelationCausespecificHazard2020}{2020}). In the
book by Beyersmann \emph{et al.}
(\citeproc{ref-beyersmannCompetingRisksMultistate2012}{2012}) (Equation
...
(\citeproc{ref-jeongDirectParametricInference2006}{Jeong and Fine,
2006}). For cause 2, we assume cause-specific proportional hazards as
\begin{equation*}
...
(\citeproc{ref-lambertFlexibleParametricModelling2017}{2017})\}, as part
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-DGM_reduc.pdf}
...
(\citeproc{ref-saadatiPredictionAccuracyVariable2018}{2018}). There, a
...
(\citeproc{ref-hallerFlexibleSimulationCompeting2014}{2014}) provide an
...
(\citeproc{ref-beyersmannCompetingRisksMultistate2012}{2012}). This DGM
...
(\citeproc{ref-austinFineGraySubdistributionHazard2021}{Austin \emph{et
al.}, 2021};
\citeproc{ref-bellachWeightedNPMLESubdistribution2019}{Bellach \emph{et
al.}, 2019}; \citeproc{ref-fineProportionalHazardsModel1999}{Fine and
Gray, 1999};
\citeproc{ref-saadatiPredictionAccuracyVariable2018}{Saadati \emph{et
al.}, 2018}).
...
\citeproc{ref-grambauerProportionalSubdistributionHazards2010}{Grambauer
\emph{et al.}, 2010}) obtained from a Fine--Gray model is perhaps a
suboptimal summary.
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-DGM_squeeze.pdf}
...
occur) (\citeproc{ref-austinFineGraySubdistributionHazard2021}{Austin
\emph{et al.}, 2021}).

Two other useful implementations of (variants of) this DGM are found in
the simulations of Mao and Lin
(\citeproc{ref-maoEfficientEstimationSemiparametric2017}{2017}), and
Mozumder \emph{et al.}
(\citeproc{ref-mozumderDirectLikelihoodInference2018}{2018}) - both
...
Latouche \emph{et al.}
(\citeproc{ref-latoucheCompetingRisksAnalysis2013}{2013}), ``it is
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fine-gray-DGM_twofgs.pdf}
...
(\citeproc{ref-gerdsAbsoluteRiskRegression2012a}{2012}). More generally,
...
(\citeproc{ref-maoEfficientEstimationSemiparametric2017}{Mao and Lin,
2017}; \citeproc{ref-shiConstrainedParametricModel2013}{Shi \emph{et
al.}, 2013}) The parametric approach suggested by Shi \emph{et al.}
(\citeproc{ref-shiConstrainedParametricModel2013}{2013})\} actually does
...
(\citeproc{ref-austinFineGraySubdistributionHazard2021}{Austin \emph{et
al.}, 2021}). The cause-specific approach also extends naturally
...
\emph{et al.} (\citeproc{ref-gerdsAbsoluteRiskRegression2012a}{2012})
...
(\citeproc{ref-wolbersPrognosticModelsCompeting2009}{2009})\} reported
...
(\citeproc{ref-kantidakisStatisticalModelsMachine2023}{2023}) also
...
accurately (noted in
\citeproc{ref-shiConstrainedParametricModel2013}{Shi \emph{et al.},
2013} for Fine--Gray models). Differences in performance may also be
...
Austin \emph{et al.}
(\citeproc{ref-austinFineGraySubdistributionHazard2021}{2021}), the
...
(\citeproc{ref-poythressPlanningAnalyzingClinical2020a}{2020}) therefore
...
(\citeproc{ref-hinchliffeFlexibleParametricModelling2013}{Hinchliffe and
Lambert, 2013};
\citeproc{ref-kipourouEstimationAdjustedCausespecific2019}{Kipourou
\emph{et al.}, 2019}).
...
(\citeproc{ref-saadatiPredictionAccuracyVariable2018}{Saadati \emph{et
al.}, 2018}). The \texttt{\{riskRegression\}} R package in particular
provides useful functions for developing and validating prediction
models based on cause-specific hazards
(\citeproc{ref-RJ-2017-062}{Ozenne \emph{et al.}, 2017}). While using a
...
\emph{et al.} (\citeproc{ref-damicoClinicalStatesCirrhosis2018}{2018})),
...
(\citeproc{ref-maoEfficientEstimationSemiparametric2017}{2017}) is a
...
outcome variable
(\citeproc{ref-kleinRegressionModelingCompeting2005a}{Klein and
Andersen, 2005}).
...
(\citeproc{ref-falkenburgGraftTumorEffects2017}{Falkenburg and Jedema,
2017}). Natural killer (NK) cells may discriminate between healthy and
...
(\citeproc{ref-dunbarRelationshipCirculatingNatural2008}{Dunbar \emph{et
al.}, 2008}; \citeproc{ref-minculescuEarlyNaturalKiller2016}{Minculescu
\emph{et al.}, 2016}). However, NK cells do not appear to be important
effector cells in GvHD
(\citeproc{ref-simonettaNaturalKillerCells2017}{Simonetta \emph{et al.},
2017}).

To reduce the risk of severe GvHD, donor T-cell depletion (TCD) can be
applied, although this will decrease the GvL effect
(\citeproc{ref-buscaInvivoExvivoCell2017}{Busca and Aversa, 2017}). In
...
after transplant
(\citeproc{ref-eeftingMyeloablativeCelldepletedAlloSCT2014}{Eefting
\emph{et al.}, 2014};
\citeproc{ref-eeftingMultistateAnalysisIllustrates2016}{Eefting \emph{et
al.}, 2016}; \citeproc{ref-falkenburgGraftTumorEffects2017}{Falkenburg
and Jedema, 2017}). DLI as part of a pre-emptive strategy is
...
(\citeproc{ref-krishnamurthyOutcomeDonorLymphocyte2013}{Krishnamurthy
\emph{et al.}, 2013}; \citeproc{ref-yunFindingSweetSpot2013}{Yun and
Waller, 2013}). Therefore, administration preferably starts a few months
after alloSCT to allow for sufficient GvL without severe GvHD
(\citeproc{ref-frederik2019delayed}{Frederik Falkenburg \emph{et al.},
2019}).
...
by Yanir \emph{et al.}
(\citeproc{ref-yanirImmuneReconstitutionAllogeneic2022}{2022}), the
...
(\citeproc{ref-boschImmuneReconstitutionAntithymocyte2012a}{Bosch
\emph{et al.}, 2012};
\citeproc{ref-hassanCMVReactivationInitiates2022}{Hassan \emph{et al.},
2022}; \citeproc{ref-sternImmunoprofilingRevealsCell2022}{Stern \emph{et
al.}, 2022}). This may distort the association between the kinetics of
...
(\citeproc{ref-bellucciImmunologicEffectsProphylactic2002}{Bellucci
\emph{et al.}, 2002};
\citeproc{ref-gooptuEffectSirolimusImmune2019}{Gooptu \emph{et al.},
2019};
\citeproc{ref-guillaumeEscalatedLymphodepletionFollowed2012}{Guillaume
\emph{et al.}, 2012};
\citeproc{ref-lewalleDonorLymphocyteInfusions2003}{Lewalle \emph{et
al.}, 2003}; \citeproc{ref-nikiforowPhaseStudyCD252016}{Nikiforow
\emph{et al.}, 2016};
\citeproc{ref-schmaelterAlterationsPeripheralBlood2021}{Schmaelter
\emph{et al.}, 2021};
\citeproc{ref-schultze-floreyClonalExpansionCD82021}{Schultze-Florey
\emph{et al.}, 2021};
\citeproc{ref-toorDynamicalSystemModeling2015}{Toor \emph{et al.},
2015}). To fully understand the complex interplay between all these
...
(\citeproc{ref-vondemborneReducedintensityConditioningAllogeneic2009a}{von
...
(\citeproc{ref-kosterCompetitiveRepopulationAlloImmunologic2023}{Koster
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-01.pdf}
...
alloSCT (\citeproc{ref-elfekyImmuneReconstitutionFollowing2019a}{Elfeky
...
(\citeproc{ref-rizopoulosJMPackageJoint2010}{Rizopoulos, 2010}) (version
1.5-2), survival (\citeproc{ref-survival-package}{Therneau, 2023})
(version 3.4.0) and nlme
(\citeproc{ref-pinheiroNlmeLinearNonlinear2023}{Pinheiro \emph{et al.},
2023}) (3.1-157). Full code needed to reproduce the results of the
present work is available at
\url{https://github.com/survival-lumc/ImmuneReconstJM}, and structured
using the targets
(\citeproc{ref-landauTargetsPackageDynamic2021}{Landau, 2021}) (version
0.14.0) package.
...
\caption{\label{tbl-table-one}\emph{Baseline characteristics}. Intention
for early low-dose DLI is based on the anticipated high risk of relapse
after alloSCT. DLI, donor lymphocyte infusion; alloSCT, allogeneic stem
cell transplantation; AML, acute myeloid leukemia; ALL, acute
lymphoblastic leukemia; MDS, myelodysplastic syndrome; Flu, fludarabine;
Bu, busulfan; Ara-C, cytarabine; Amsa, amsacrine; RD, related donor; UD,
unrelated donor; GCSF, granulocyte-colony stimulation factor; PBSC,
peripheral blood stem cells; BM, bone marrow. *One patient had not
received a second consolidation course before transplant and received 2
days cyclophosphamide 750 mg/m2 intravenously additionally to the
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-02.pdf}
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-03.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-04.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-05.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-06.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/joint-models-DLI_fig-07.pdf}
...
(\citeproc{ref-fleischhauerEffectTcellepitopeMatching2012}{Fleischhauer
\emph{et al.}, 2012};
\citeproc{ref-marianoAssessmentExtendedCoverageNextGeneration2019}{Mariano
\emph{et al.}, 2019};
\citeproc{ref-shawImportanceHLADPB1Unrelated2007}{Shaw \emph{et al.},
2007}) could contribute to the strong association between CD4+ T-cells
...
(\citeproc{ref-boschImmuneReconstitutionAntithymocyte2012a}{Bosch
\emph{et al.}, 2012};
\citeproc{ref-itoImpactLowdoseAntithymocyte2020}{Ito \emph{et al.},
2020};
\citeproc{ref-penackSerotherapyThymoglobulinAlemtuzumab2008}{Penack
\emph{et al.}, 2008}), nor by DLI. As previously reported
(\citeproc{ref-dunbarRelationshipCirculatingNatural2008}{Dunbar \emph{et
al.}, 2008}; \citeproc{ref-mccurdySignaturesGVHDRelapse2022}{McCurdy
...
\citeproc{ref-guillaumeEscalatedLymphodepletionFollowed2012}{Guillaume
\emph{et al.}, 2012};
\citeproc{ref-nikiforowPhaseStudyCD252016}{Nikiforow \emph{et al.},
2016};
\citeproc{ref-schultze-floreyClonalExpansionCD82021}{Schultze-Florey
...
(\citeproc{ref-guillaumeEscalatedLymphodepletionFollowed2012}{2012}) and
Schultze-Florey \emph{et al.}
(\citeproc{ref-schultze-floreyClonalExpansionCD82021}{2021}) only
...
(\citeproc{ref-nikiforowPhaseStudyCD252016}{2016}) and the mixed model
used by Bellucci \emph{et al.}
(\citeproc{ref-bellucciImmunologicEffectsProphylactic2002}{2002})
...
(\citeproc{ref-salzmann-manriqueJointModelingImmune2018a}{Salzmann-Manrique
...
(\citeproc{ref-mccurdySignaturesGVHDRelapse2022}{McCurdy \emph{et al.},
2022}). For DLI, we would suggest to perform a prospective study where
...
developed
(\citeproc{ref-andrinopoulouDynamicPredictionOutcome2015}{Andrinopoulou
...
(\citeproc{ref-dekkerReconstitutionCellSubsets2020a}{Dekker \emph{et
al.}, 2020}; \citeproc{ref-uhlMetabolicReprogrammingDonor2020}{Uhl
\emph{et al.}, 2020}).
...
(\citeproc{ref-bakerSystematicReviewReporting2024}{Baker \emph{et al.},
2024}; \citeproc{ref-carrollHowAreMissing2020}{Carroll \emph{et al.},
2020}; \citeproc{ref-mainzerGapsUsageReporting2024}{Mainzer \emph{et
al.}, 2024}), and literature has also investigated the approach of first
multiply imputing missing values prior to applying any inclusion
criteria in each imputed dataset
(\citeproc{ref-austinImputethenexcludeExcludethenimputeLessons2023}{Austin
\emph{et al.}, 2023}).
...
(\citeproc{ref-hayatirezvanRiseMultipleImputation2015}{Hayati Rezvan
\emph{et al.}, 2015}), although it should be noted that the present
...
(\citeproc{ref-sterneMultipleImputationMissing2009}{Sterne \emph{et
al.}, 2009}). The latter is particularly important, since the imputation
...
(\citeproc{ref-whiteImputingMissingCovariate2009}{White and Royston,
2009}). Additionally including the interactions of all cumulative
...
(\citeproc{ref-bartlettMultipleImputationCovariates2015}{2015}), and
adapted for cause-specific Cox outcome models by Bartlett and Taylor
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}). This
...
\citeproc{ref-sorrorHematopoieticCellTransplantation2005a}{Sorror
\emph{et al.}, 2005}) and body mass index (BMI) on the cause-specific
...
matching (\citeproc{ref-kleinkeMultipleImputationViolated2017}{Kleinke,
2017}; \citeproc{ref-leeMultipleImputationPresence2017a}{Lee and Carlin,
2017b}). However, there is also a lack of research regarding the use of
...
(\citeproc{ref-clementsMultipleImputationDerived2022}{2022}) (see Figure
...
(\citeproc{ref-ruanAnalysesCumulativeIncidence2008}{Ruan and Gray,
2008}), and then covariates are imputed using the resulting
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{Bartlett and
Taylor, 2016}), suggest that SMC-FCS should be the go-to for imputing
...
(\citeproc{ref-austinMultipleImputationCompeting2024}{2024}) considered
...
simulated datasets
(\citeproc{ref-nowokSynthpopBespokeCreation2016}{Nowok \emph{et al.},
2016}), or use resampling-based methods (e.g.~as done in
\citeproc{ref-shahComparisonRandomForest2014}{Shah \emph{et al.},
2014}).
...
and Taylor (\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016})
and Austin (\citeproc{ref-austinMultipleImputationCompeting2024}{2024}).
...
\citeproc{ref-quartagnoMultipleImputationDiscrete2019}{Quartagno and
Carpenter, 2019}) or a fully Bayesian approach using sequential
factorization (e.g.
\citeproc{ref-erlerDealingMissingCovariates2016}{Erler \emph{et al.},
2016}), circumvent this issue and can also impute compatibly with a
...
(\citeproc{ref-bartlettMissingCovariatesCompeting2016}{2016}), a more
...
Lee \emph{et al.}
(\citeproc{ref-leeFrameworkTreatmentReporting2021}{2021}) with focus on
...
(\citeproc{ref-salzmann-manriqueJointModelingImmune2018a}{Salzmann-Manrique
\emph{et al.}, 2018}), while other work in the domain of alloSCT
considered different longitudinal measurements such as minimal residual
disease (\citeproc{ref-huangDynamicPredictionRelapse2021}{Huang \emph{et
al.}, 2021}) or donor chimerism
(\citeproc{ref-tangIncreasingChimerismAllogeneic2014a}{Tang \emph{et
al.}, 2014}). We were able to capture the shape of highly non-linear
...
(\citeproc{ref-rizopoulosJMbayes2ExtendedJoint2023}{Rizopoulos \emph{et
al.}, 2023}), the limited number of patients and events in the cohort
...
\citeproc{ref-rouanetInterpretationMixedModels2019a}{Rouanet \emph{et
al.}, 2019} for more general discussion), and to quantify the added
...
\citeproc{ref-tompsettUseNotrandomFully2018}{Tompsett \emph{et al.},
2018}).

Furthermore, throughout this thesis, we placed a particular emphasis on
Open Science and its principles
(\citeproc{ref-vicente-saezOpenScienceNow2018}{Vicente-Saez and
Martinez-Fuentes, 2018}). Analyses for the different chapters are
implemented using the free software R
(\citeproc{ref-rcoreteamLanguageEnvironmentStatistical2024}{R Core Team,
2024}), and documented code is openly available at
...
(\citeproc{ref-boulesteixPleaNeutralComparison2013}{Boulesteix \emph{et
al.}, 2013}); b) replication studies, which are notoriously rare in
methodological research
(\citeproc{ref-boulesteixReplicationCrisisMethodological2020a}{Boulesteix
\emph{et al.}, 2020}; \citeproc{ref-lohmannItsTimeTen2022}{Lohmann
\emph{et al.}, 2022}).
...
\bibitem[\citeproctext]{ref-acosta-medinaComparisonPretransplantationPrediction2023}
...
\bibitem[\citeproctext]{ref-adesMyelodysplasticSyndromes2014}
...
\bibitem[\citeproctext]{ref-allignolSoftwareFittingNonstandard2010}
...
\bibitem[\citeproctext]{ref-andersenInterpretabilityImportanceFunctionals2012}
...
\bibitem[\citeproctext]{ref-andersenModelsMultiStateSurvival2023}
Andersen, P. K. and Ravn, H. (2023) \emph{Models for {Multi-State
Survival Data}: {Rates}, {Risks}, and {Pseudo-Values}}. CRC Press.

\bibitem[\citeproctext]{ref-andersenCompetingRisksMultistate2002}
...
\bibitem[\citeproctext]{ref-andersenCompetingRisksEpidemiology2012}
...
\bibitem[\citeproctext]{ref-andrinopoulouDynamicPredictionOutcome2015}
...
\bibitem[\citeproctext]{ref-antunesDealingMissingInformation2021}
...
\bibitem[\citeproctext]{ref-archerDevelopmentExternalValidation2022}
...
\bibitem[\citeproctext]{ref-armandDiseaseRiskIndex2012}
...
\bibitem[\citeproctext]{ref-armandValidationRefinementDisease2014}
...
\bibitem[\citeproctext]{ref-austinMultipleImputationCompeting2024}
...
\bibitem[\citeproctext]{ref-austinFineGraySubdistributionHazard2021}
...
\bibitem[\citeproctext]{ref-austinImputethenexcludeExcludethenimputeLessons2023}
...
\bibitem[\citeproctext]{ref-bakerSystematicReviewReporting2024}
...
\bibitem[\citeproctext]{ref-bakoyannisModellingCompetingRisks2010}
...
\bibitem[\citeproctext]{ref-bartlettMissingCovariatesCompeting2016}
...
\bibitem[\citeproctext]{ref-bartlettMultipleImputationCovariates2015}
...
\bibitem[\citeproctext]{ref-bartlettSmcfcsMultipleImputation2022}
...
\bibitem[\citeproctext]{ref-beesleyMultipleImputationMissing2016}
...
\bibitem[\citeproctext]{ref-bellHandlingMissingData2014}
...
\bibitem[\citeproctext]{ref-bellachWeightedNPMLESubdistribution2019}
...
\bibitem[\citeproctext]{ref-bellucciImmunologicEffectsProphylactic2002}
...
\bibitem[\citeproctext]{ref-beyersmannSimulatingCompetingRisks2009}
...
\bibitem[\citeproctext]{ref-beyersmannCompetingRisksMultistate2012}
...
\bibitem[\citeproctext]{ref-blakeEstimatingTreatmentEffects2020}
...
\bibitem[\citeproctext]{ref-bonnevilleMultipleImputationCausespecific2022}
...
\bibitem[\citeproctext]{ref-bonnevilleHandlingMissingCovariate2023}
...
\bibitem[\citeproctext]{ref-bonnevilleWhyYouShould2024a}
...
\bibitem[\citeproctext]{ref-boschImmuneReconstitutionAntithymocyte2012a}
...
\bibitem[\citeproctext]{ref-boulesteixPleaNeutralComparison2013}
...
\bibitem[\citeproctext]{ref-boulesteixReplicationCrisisMethodological2020a}
...
\bibitem[\citeproctext]{ref-burtonMissingCovariateData2004}
...
\bibitem[\citeproctext]{ref-buscaInvivoExvivoCell2017}
...
\bibitem[\citeproctext]{ref-carpenterMissingDataStatistical2021}
...
\bibitem[\citeproctext]{ref-carpenter2023MI}
...
\bibitem[\citeproctext]{ref-carrollHowAreMissing2020}
...
\bibitem[\citeproctext]{ref-chiangStochasticStudyLife1961}
...
\bibitem[\citeproctext]{ref-clementsMultipleImputationDerived2022}
...
\bibitem[\citeproctext]{ref-cliftLivingRiskPrediction2020}
...
\bibitem[\citeproctext]{ref-cornfieldEstimationProbabilityDeveloping1957}
Cornfield, J. (1957)
...
\bibitem[\citeproctext]{ref-coxPartialLikelihood1975}
...
\bibitem[\citeproctext]{ref-damicoClinicalStatesCirrhosis2018}
...
\bibitem[\citeproctext]{ref-dewreedeMstatePackageEstimation2010}
...
\bibitem[\citeproctext]{ref-dewreedeMstatePackageAnalysis2011}
...
\bibitem[\citeproctext]{ref-dekkerReconstitutionCellSubsets2020a}
...
\bibitem[\citeproctext]{ref-delgadoSurvivalAnalysisHematologic2014}
...
\bibitem[\citeproctext]{ref-delordMultipleImputationCompeting2016}
...
\bibitem[\citeproctext]{ref-demirtasComputingPointbiserialCorrelation2016}
...
\bibitem[\citeproctext]{ref-dondersReviewGentleIntroduction2006}
...
\bibitem[\citeproctext]{ref-duCompatibilityImputationSpecification2022}
...
\bibitem[\citeproctext]{ref-dunbarRelationshipCirculatingNatural2008}
...
\bibitem[\citeproctext]{ref-eeftingMyeloablativeCelldepletedAlloSCT2014}
...
\bibitem[\citeproctext]{ref-eeftingMultistateAnalysisIllustrates2016}
...
\bibitem[\citeproctext]{ref-elfekyImmuneReconstitutionFollowing2019a}
...
\bibitem[\citeproctext]{ref-erlerDealingMissingCovariates2016}
...
\bibitem[\citeproctext]{ref-erlerJointAIJointAnalysis2021}
...
\bibitem[\citeproctext]{ref-falcaroEstimatingExcessHazard2015}
...
\bibitem[\citeproctext]{ref-falkenburgGraftTumorEffects2017}
...
\bibitem[\citeproctext]{ref-fineProportionalHazardsModel1999}
...
\bibitem[\citeproctext]{ref-fleischhauerEffectTcellepitopeMatching2012}
...
\bibitem[\citeproctext]{ref-frederik2019delayed}
...
\bibitem[\citeproctext]{ref-gaspariniRsimsumSummariseResults2018}
...
\bibitem[\citeproctext]{ref-gerdsAbsoluteRiskRegression2012a}
...
\bibitem[\citeproctext]{ref-geskusCauseSpecificCumulativeIncidence2011}
...
\bibitem[\citeproctext]{ref-geskusCompetingRisksConcepts2024}
...
\bibitem[\citeproctext]{ref-gooptuEffectSirolimusImmune2019}
...
\bibitem[\citeproctext]{ref-gorgizadehImputationApproachUsing2022a}
...
\bibitem[\citeproctext]{ref-grambauerProportionalSubdistributionHazards2010}
...
\bibitem[\citeproctext]{ref-grayClassKSampleTests1988}
...
\bibitem[\citeproctext]{ref-groenwoldMissingCovariateData2012}
...
\bibitem[\citeproctext]{ref-guillaumeEscalatedLymphodepletionFollowed2012}
...
\bibitem[\citeproctext]{ref-haenschMultipleImputationPartially2022}
...
\bibitem[\citeproctext]{ref-hallerFlexibleSimulationCompeting2014}
...
\bibitem[\citeproctext]{ref-hanSecondaryCytogeneticAbnormalities2021}
...
\bibitem[\citeproctext]{ref-hansenELN2017Genetic2021}
...
\bibitem[\citeproctext]{ref-hassanCMVReactivationInitiates2022}
...
\bibitem[\citeproctext]{ref-hayatirezvanRiseMultipleImputation2015}
...
\bibitem[\citeproctext]{ref-hickeyJointModellingTimetoevent2016}
...
\bibitem[\citeproctext]{ref-hickeyComparisonJointModels2018a}
...
\bibitem[\citeproctext]{ref-hinchliffeFlexibleParametricModelling2013}
...
\bibitem[\citeproctext]{ref-horowitzGraftversusleukemiaReactionsBone1990}
...
\bibitem[\citeproctext]{ref-horowitzRoleRegistriesFacilitating2008}
...
\bibitem[\citeproctext]{ref-huangDynamicPredictionRelapse2021}
...
\bibitem[\citeproctext]{ref-hughesAccountingMissingData2019}
...
\bibitem[\citeproctext]{ref-inoueImpactConditioningIntensity2021}
...
\bibitem[\citeproctext]{ref-itoImpactLowdoseAntithymocyte2020}
...
\bibitem[\citeproctext]{ref-jeongDirectParametricInference2006}
...
\bibitem[\citeproctext]{ref-keoghMultipleImputationCox2018}
...
\bibitem[\citeproctext]{ref-kipourouEstimationAdjustedCausespecific2019}
...
\bibitem[\citeproctext]{ref-kleinRegressionModelingCompeting2005a}
...
\bibitem[\citeproctext]{ref-kleinSurvivalAnalysisTechniques2006}
...
\bibitem[\citeproctext]{ref-kleinkeMultipleImputationViolated2017}
...
\bibitem[\citeproctext]{ref-kosterCompetitiveRepopulationAlloImmunologic2023}
...
\bibitem[\citeproctext]{ref-krishnamurthyOutcomeDonorLymphocyte2013}
...
\bibitem[\citeproctext]{ref-krogerIndicationManagementAllogeneic2024}
...
\bibitem[\citeproctext]{ref-lambertFlexibleParametricModelling2017}
...
\bibitem[\citeproctext]{ref-landauTargetsPackageDynamic2021}
Landau, W. M. (2021) The targets {R} package: A dynamic {Make-like}
function-oriented pipeline toolkit for reproducibility and
high-performance computing. \emph{Journal of Open Source Software},
\textbf{6}, 2959.

\bibitem[\citeproctext]{ref-latoucheMisspecifiedRegressionModel2007}
...
\bibitem[\citeproctext]{ref-latoucheCompetingRisksAnalysis2013}
...
\bibitem[\citeproctext]{ref-lauMissingnessSettingCompeting2018}
...
\bibitem[\citeproctext]{ref-leeMultipleImputationPresence2017}
...
\bibitem[\citeproctext]{ref-leeMultipleImputationPresence2017a}
Lee, K. J. and Carlin, J. B. (2017b) Multiple imputation in the presence
of non-normal data. \emph{Statistics in Medicine}, \textbf{36},
606--617. DOI:
\href{https://doi.org/10.1002/sim.7173}{10.1002/sim.7173}.

\bibitem[\citeproctext]{ref-leeFrameworkTreatmentReporting2021}
...
\bibitem[\citeproctext]{ref-leeAssumptionsAnalysisPlanning2023}
...
\bibitem[\citeproctext]{ref-lennonObesityParadoxCancer2016}
...
\bibitem[\citeproctext]{ref-lewalleDonorLymphocyteInfusions2003}
...
\bibitem[\citeproctext]{ref-littleMissingDataAssumptions2021}
...
\bibitem[\citeproctext]{ref-littleMissingDataAnalysis2024}
...
\bibitem[\citeproctext]{ref-little1987statistical}
Little, R. J. and Rubin, D. B. (1987) Statistical analysis with missing
data. \emph{New York: Wiley}.

\bibitem[\citeproctext]{ref-littleModelingDropOutMechanism1995}
...
\bibitem[\citeproctext]{ref-littleStatisticalAnalysisMissing2019}
Little, R. J. A. and Rubin, D. B. (2019) \emph{Statistical {Analysis}
with {Missing Data}}. John Wiley \& Sons.

\bibitem[\citeproctext]{ref-liuStationaryDistributionIterative2014}
...
\bibitem[\citeproctext]{ref-lohmannItsTimeTen2022}
...
\bibitem[\citeproctext]{ref-madley-dowdProportionMissingData2019}
...
\bibitem[\citeproctext]{ref-mainzerGapsUsageReporting2024}
...
\bibitem[\citeproctext]{ref-maoEfficientEstimationSemiparametric2017}
...
\bibitem[\citeproctext]{ref-marianoAssessmentExtendedCoverageNextGeneration2019}
...
\bibitem[\citeproctext]{ref-mariniMaximumLikelihoodEstimationPanel1980}
...
\bibitem[\citeproctext]{ref-marshallCombiningEstimatesInterest2009}
...
\bibitem[\citeproctext]{ref-marshallComparisonImputationMethods2010}
...
\bibitem[\citeproctext]{ref-martinussenEstimationSeparableDirect2023a}
...
\bibitem[\citeproctext]{ref-mccullagh1989generalized}
...
\bibitem[\citeproctext]{ref-mccurdySignaturesGVHDRelapse2022}
...
\bibitem[\citeproctext]{ref-mengMultipleImputationInferencesUncongenial1994}
...
\bibitem[\citeproctext]{ref-mertensConstructionAssessmentPrediction2020}
...
\bibitem[\citeproctext]{ref-minculescuEarlyNaturalKiller2016}
...
\bibitem[\citeproctext]{ref-morisotProstateCancerNet2015}
...
\bibitem[\citeproctext]{ref-mozumderDirectLikelihoodInference2018}
...
\bibitem[\citeproctext]{ref-murrayMultipleImputationReview2018}
...
\bibitem[\citeproctext]{ref-nikiforowPhaseStudyCD252016}
...
\bibitem[\citeproctext]{ref-nowokSynthpopBespokeCreation2016}
...
\bibitem[\citeproctext]{ref-RJ-2017-062}
...
\bibitem[\citeproctext]{ref-papageorgiouAlternativeCharacterizationMAR2021}
...
\bibitem[\citeproctext]{ref-papageorgiouOverviewJointModeling2019a}
...
\bibitem[\citeproctext]{ref-passamontiDynamicPrognosticModel2010}
...
\bibitem[\citeproctext]{ref-pazGenomicAnalysisPrimary2021}
...
\bibitem[\citeproctext]{ref-penackSerotherapyThymoglobulinAlemtuzumab2008}
...
\bibitem[\citeproctext]{ref-pinheiroNlmeLinearNonlinear2023}
Pinheiro, J., Bates, D. and R Core Team (2023) \emph{Nlme: {Linear} and
Nonlinear Mixed Effects Models}. Manual.

\bibitem[\citeproctext]{ref-polverelliMultidimensionalGeriatricAssessment2020}
...
\bibitem[\citeproctext]{ref-polverelliImpactSpleenSize2021a}
...
\bibitem[\citeproctext]{ref-polverelliSplenomegalyPatientsPrimary2023}
...
\bibitem[\citeproctext]{ref-polverelliImpactComorbiditiesBody2024a}
...
\bibitem[\citeproctext]{ref-poythressPlanningAnalyzingClinical2020a}
...
\bibitem[\citeproctext]{ref-prenticeAnalysisFailureTimes1978}
...
\bibitem[\citeproctext]{ref-putterTutorialBiostatisticsCompeting2007}
...
\bibitem[\citeproctext]{ref-putterRelationCausespecificHazard2020}
...
\bibitem[\citeproctext]{ref-quartagnoMultipleImputationDiscrete2019}
...
\bibitem[\citeproctext]{ref-resche-rigonImputingMissingCovariate2012}
...
\bibitem[\citeproctext]{ref-rizopoulosJMPackageJoint2010}
...
\bibitem[\citeproctext]{ref-rizopoulosJointModelsLongitudinal2012}
Rizopoulos, D. (2012) \emph{Joint {Models} for {Longitudinal} and
{Time-to-Event Data}}. 1st edition. Boca Raton: Routledge.

\bibitem[\citeproctext]{ref-rizopoulosJMbayes2ExtendedJoint2023}
...
\bibitem[\citeproctext]{ref-rouanetInterpretationMixedModels2019a}
...
\bibitem[\citeproctext]{ref-ruanAnalysesCumulativeIncidence2008}
...
\bibitem[\citeproctext]{ref-rubin:1987}
...
\bibitem[\citeproctext]{ref-rubinInferenceMissingData1976}
Rubin, D. B. (1976) Inference and missing data. \emph{Biometrika},
\textbf{63}, 581--592. DOI:
\href{https://doi.org/10.1093/biomet/63.3.581}{10.1093/biomet/63.3.581}.

\bibitem[\citeproctext]{ref-ruckerPresentingSimulationResults2014}
...
\bibitem[\citeproctext]{ref-saadatiPredictionAccuracyVariable2018}
...
\bibitem[\citeproctext]{ref-saccardiBenchmarkingSurvivalOutcomes2023}
...
\bibitem[\citeproctext]{ref-salzmann-manriqueJointModelingImmune2018a}
...
\bibitem[\citeproctext]{ref-scheteligLateTreatmentrelatedMortality2019}
...
\bibitem[\citeproctext]{ref-schmaelterAlterationsPeripheralBlood2021}
...
\bibitem[\citeproctext]{ref-schultze-floreyClonalExpansionCD82021}
...
\bibitem[\citeproctext]{ref-seamanWhatMeantMissing2013}
...
\bibitem[\citeproctext]{ref-shahComparisonRandomForest2014}
...
\bibitem[\citeproctext]{ref-sharmaOutcomesPediatricPatients2021}
...
\bibitem[\citeproctext]{ref-shawImportanceHLADPB1Unrelated2007}
...
\bibitem[\citeproctext]{ref-shiConstrainedParametricModel2013}
...
\bibitem[\citeproctext]{ref-shimoniLongtermSurvivalLate2016}
...
\bibitem[\citeproctext]{ref-simonettaNaturalKillerCells2017}
...
\bibitem[\citeproctext]{ref-snowdenBenchmarkingSurvivalOutcomes2020}
...
\bibitem[\citeproctext]{ref-sorrorHematopoieticCellTransplantation2005a}
...
\bibitem[\citeproctext]{ref-sternImmunoprofilingRevealsCell2022}
...
\bibitem[\citeproctext]{ref-sterneROBINSIToolAssessing2016}
...
\bibitem[\citeproctext]{ref-sterneMultipleImputationMissing2009}
...
\bibitem[\citeproctext]{ref-sullivanTreatmentMissingData2017}
...
\bibitem[\citeproctext]{ref-sullivanShouldMultipleImputation2018}
...
\bibitem[\citeproctext]{ref-sweetingJointModellingLongitudinal2011}
...
\bibitem[\citeproctext]{ref-tangIncreasingChimerismAllogeneic2014a}
...
\bibitem[\citeproctext]{ref-taylor2002survival}
...
\bibitem[\citeproctext]{ref-tompsettUseNotrandomFully2018}
...
\bibitem[\citeproctext]{ref-toorDynamicalSystemModeling2015}
...
\bibitem[\citeproctext]{ref-uhlMetabolicReprogrammingDonor2020}
...
\bibitem[\citeproctext]{ref-buurenFlexibleImputationMissing2018}
van Buuren, S. (2018) \emph{Flexible {Imputation} of {Missing Data},
{Second Edition}}. Boca Raton, FL: Chapman \& Hall/CRC Press.

\bibitem[\citeproctext]{ref-vanbuurenMiceMultivariateImputation2011}
...
\bibitem[\citeproctext]{ref-vanbuurenFlexibleMultivariateImputation1999}
van Buuren, S., Oudshoorn, K. and TNO Preventie en Gezondheid (1999)
\emph{Flexible {Multivariate Imputation} by {MICE}}. January. TNO.

\bibitem[\citeproctext]{ref-vanbuurenFullyConditionalSpecification2006}
...
\bibitem[\citeproctext]{ref-vanderpasDifferentCompetingRisks2018}
...
\bibitem[\citeproctext]{ref-vanhouwelingenDynamicPredictionClinical2012}
...
\bibitem[\citeproctext]{ref-vandenbrouckeStrengtheningReportingObservational2007}
...
\bibitem[\citeproctext]{ref-vicente-saezOpenScienceNow2018}
...
\bibitem[\citeproctext]{ref-vondemborneReducedintensityConditioningAllogeneic2009a}
...
\bibitem[\citeproctext]{ref-vonhippelHowManyImputations2020}
...
\bibitem[\citeproctext]{ref-whiteBiasEfficiencyMultiple2010}
...
\bibitem[\citeproctext]{ref-whiteImputingMissingCovariate2009}
...
\bibitem[\citeproctext]{ref-whiteAdjustingPartiallyMissing2005}
...
\bibitem[\citeproctext]{ref-whiteMissingDataPart2022}
...
\bibitem[\citeproctext]{ref-wolbersPrognosticModelsCompeting2009}
...
\bibitem[\citeproctext]{ref-woodEstimationUsePredictions2015}
...
\bibitem[\citeproctext]{ref-yanirImmuneReconstitutionAllogeneic2022}
...
\bibitem[\citeproctext]{ref-youngCausalFrameworkClassical2020a}
...
\bibitem[\citeproctext]{ref-yunFindingSweetSpot2013}
...
\bibitem[\citeproctext]{ref-zhuConvergencePropertiesSequential2015}
